                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                            <label class="form-control-label">Threshold Attendance Percentage<span class="text-danger ml-2">*</span></label>
              ...
              if(isset($_POST['view'])) {
                  ...
                  if ($num > 0) {
                      ...
                      while ($rows = $rs->fetch_assoc()) {
                          $attendancePercentage = ($rows['presentDays'] / $rows['totalDays']) * 100;
                      ...
                      if (!empty($studentsBelowThreshold)) {
                          ...
                          <form method="post" action="send_mail.php">
                              <input type="hidden" name="students" value="'.implode(',', $studentsBelowThreshold).'">
                              <button type="submit" class="btn btn-warning">Send Mail to Students Below Threshold</button>
                          </form>';
                      }
                  } else {
